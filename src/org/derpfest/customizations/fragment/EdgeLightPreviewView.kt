...
class EdgeLightPreviewView @JvmOverloads constructor(
    ...
    private fun readSettingsAndStart() {
        ...
        try {
            Settings.System.getStringForUser(
                resolver, Settings.System.EDGE_LIGHT_COLOR_MODE, UserHandle.USER_CURRENT
            )?.let { colorMode = it }
        } catch (_: Exception) {}
        try {
            customColor = Settings.System.getIntForUser(
                resolver, Settings.System.EDGE_LIGHT_CUSTOM_COLOR, -1, UserHandle.USER_CURRENT
            )
        } catch (_: Exception) {}
        try {
            pulseCount = Settings.System.getIntForUser(
                resolver, Settings.System.EDGE_LIGHT_PULSE_COUNT, 3, UserHandle.USER_CURRENT
            )
        } catch (_: Exception) {}
        try {
            strokeWidth = Settings.System.getIntForUser(
                resolver, Settings.System.EDGE_LIGHT_STROKE_WIDTH, 8, UserHandle.USER_CURRENT
            )
        } catch (_: Exception) {}
        try {
            Settings.System.getStringForUser(
        ...
        try {
            Settings.System.getStringForUser(
                resolver, Settings.System.EDGE_LIGHT_ANIMATION_EFFECT, UserHandle.USER_CURRENT
            )?.let { effect = it }
        } catch (_: Exception) {}
    ...
    companion object {
        private val WATCHED_KEYS = arrayOf(
            ...
            Settings.System.EDGE_LIGHT_PULSE_COUNT,
            Settings.System.EDGE_LIGHT_STROKE_WIDTH,
            Settings.System.EDGE_LIGHT_STYLE,
